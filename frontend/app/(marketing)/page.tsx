...
export default function Home() {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      ...
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[500px] h-[250px] bg-brand/15 blur-[120px] rounded-full pointer-events-none -z-10" />
      ...
      <main className="flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl mx-auto gap-12 lg:gap-16">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1 max-w-xl">
          ...
          <div className="flex flex-wrap items-center gap-3 mt-8 justify-center lg:justify-start">
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-brand to-brand-hover hover:brightness-110 text-white font-semibold text-sm transition-all shadow-lg shadow-brand/30 cursor-pointer"
            >
          ...
          {/* Quick CLI command */}
          <div className="mt-5 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-brand-surface/40 border border-brand-border/30 text-xs font-mono text-zinc-400">
        ...
        <div className="w-full flex-1 max-w-xl lg:max-w-2xl flex flex-col rounded-2xl border border-brand-border/30 bg-brand-surface/30 shadow-2xl backdrop-blur-md overflow-hidden">
          {/* App Window Top Bar */}
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-brand-border/30 bg-brand-surface/50">
